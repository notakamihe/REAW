...
export default class DNR extends React.Component<IProps, IState> {
  ...
  onMouseMoveDrag = (e: MouseEvent) => {
    ...
    this.setState({coords, delta}, () => this.props.onDrag && this.props.onDrag(e, this.getDNRData()));
  }
  ...
  onMouseMoveResize = (e: MouseEvent) => {
    ...
    if (el) {
      ...
      switch (this.state.dir) {
        case ResizeDirection.Left:
          coords.startX += e.movementX;
          resizedFrom.left = true;
          break;
        case ResizeDirection.Right:
          coords.endX += e.movementX;
          resizedFrom.right = true;
          break;
        case ResizeDirection.Top:
          coords.startY += e.movementY;
          resizedFrom.top = true;
          break;
        case ResizeDirection.Bottom:
          coords.endY += e.movementY;
  ...
  onMouseUpDrag = (e : MouseEvent) => {
    ...
    this.setState({dragging: false, coords}, () => this.props.onDragStop && this.props.onDragStop(e, data));
  }
  ...
  onMouseUpResize = (e : MouseEvent) => {
    ...
    this.setState({resizing: false, coords}, () => {
    ...
    return (
      <div 
        ...
        style={{
          ...
          width: this.getSize().width, 
          height: this.getSize().height, 
          transform: `translate(${this.state.coords.startX}px, ${this.state.coords.startY}px)`,
